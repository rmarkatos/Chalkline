...
export function set(r, v){ localWrite(r.path, JSON.parse(JSON.stringify(v))); return Promise.resolve(); }
export function remove(r){ localWrite(r.path, null); return Promise.resolve(); }
